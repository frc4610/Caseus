...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1 = new JoystickButton(controlStick, 5);
        joystickButton1.whileHeld(new Retrieve());
        
        joystickButton2 = new JoystickButton(controlStick, 6);
        joystickButton2.whileHeld(new Expell());
        
        joystickButton3 = new JoystickButton(controlStick, 3);
        joystickButton3.whileHeld(new CleanandStand());
        
        joystickbutton4 = new JoystickButton(controlStick, 1);
        joystickbutton4.whileHeld(new Takeadump());
        
        joystickbutton4 = new JoystickButton(controlStick, 4);
